export const sendMail = (token, teamId, memberName, memberEmail) => {
          ...
          <body>
              <div class='container'>
                  ...
                  <div class='button-container'>
                     <a class='access-button' href='https://esencia.app/survey?token=${token}&team_id=${teamId}' target='_blank'>Access to survey</a>
                  </div>
              </div>
          </body>
