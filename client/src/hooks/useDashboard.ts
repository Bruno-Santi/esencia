...
export const useDashboard = () => {
  ...
  const startGettingDataFunc = async (id, sprint, triggered) => {
    try {
      ...
      console.log(surveyData.longRecommendation === "There is no enough data");

      if (surveyData.longRecommendation !== "There is no enough data" || surveyData.longRecommendation !== "There is no retro") {
