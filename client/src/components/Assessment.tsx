...
export const Assessment = () => {
  ...
  return (
    <section className='flex flex-col space-y-2 font-inter text-primary lg:mt-20 md:mt-20 sm:mt-10 lg:ml-40 md:ml-10 sm:ml-0 sm:mb-6'>
      <h1 className='lg:text-left font-bold md:text-left sm:text-left lg:text-3xl md:text-2xl  sm:text-3xl sm:w-2/3 sm:ml-12  '>
        Agile Assessment <br></br>
        <span className='text-lg font-normal font-poppins sm:text-base sm:w-2/3  '>
          Descubre el estado de agilidad de tu equipo con nuestro Agile Assessment.
        </span>
      </h1>
      ...
      <section className='lg:flex lg:flex-row md:flex md:flex-row sm:flex-col lg:justify-center sm:p-2   lg:ml-0 md:justify-between lg:w-5/6 lg:items-center lg:m-auto sm:mt-6  lg:mt-24 '>
        <div className='bg-white lg:flex  lg:mt-6   lg:space-x-6  lg:flex-row lg:items-start  shadow-lg shadow-primary/20 lg:h-[570px] md:min-h-[570px] p-12 rounded-md font-inter sm:flex-col sm:justify-center  sm:items-center md:w-6/6  lg:w-5/6 space-y-0 lg:ml-8 md:ml-0 sm:ml-0 sm:w-full '>
          ...
          <div className='space-y-6 '>
            ...
            <br></br>{" "}
            <div className='flex flex-col items-center justify-center relative lg:right-36 md:right-2 -bottom-2 text-center'>
        ...
        <div className='bg-white shadow-lg shadow-primary/20 p-12  sm:w-full sm:p-6 sm:mt-6 sm:mb-20 lg:h-[570px] md:min-h-[570px] rounded-md font-inter sm:flex-col sm:justify-center sm:m-auto sm:items-center md:w-2/3  lg:w-4/6 sm:w-5/6 space-y-6 lg:ml-12 md:ml-40 '>
