    ...
    >
      <div className='flex flex-col  md:h-2/3 lg:h-full  my-auto place-content-center items-center  justify-center pt-12 lg:p-20 space-y-6 lg:space-y-8 animate__animated animate__fadeIn animate__slower '>
        <div className='flex flex-col justify-center place-content-center lg:mt-0 md:mt-40 space-y-8'>
          <img src={logo} className=' w-1/6 md:w-[129px] lg:w-[129px] m-auto animate-pulse duration-700' alt='esencia.app logo' />
          <span className='md:text-rose text-tertiary/40 text-lg lg:text-2xl  font-poppins font-bold italic m-auto'>By Agile Leaders for Agile Leaders</span>
          <Divider />
          ...
          <p className='w-10/12 lg:w-6/12 text-center text-tertiary m-auto font-thin text-lg lg:text-xl'>
            At the heart of our mission is the drive to <span className='font-bold text-secondary'>elevate your leadership</span> skills to unprecedented
            heights, transcending traditional boundaries.
          </p>
          <p className='w-10/12  lg:w-6/12 text-center text-tertiary m-auto font-thin text-lg lg:text-xl'>
            As we're in the early stages of bringing <span className='font-bold text-secondary'>Esencia.app</span> to life,
            <span className='font-bold text-secondary'> we welcome your insights and suggestions</span> to shape this platform perfectly for its intended users,
            leaders like you.
          </p>
          <p className='w-10/12 lg:w-6/12 text-center text-tertiary m-auto font-thin text-lg lg:text-xl'>
