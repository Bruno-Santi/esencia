...
export const Home = () => {
  return (
    <section className=' lg:flex lg:flex-row md:flex md:flex-row sm:flex-col lg:justify-between md:justify-between min-w-full sm:mt-6 md:mt-16  lg:mt-24'>
      <div className='font-inter sm:flex-col sm:justify-center sm:m-auto sm:items-center md:w-2/3 lg:w-2/3 sm:w-5/6 space-y-6 lg:ml-40 md:ml-40 '>
        <h1 className=' sm:text-2xl  lg:text-5xl md:text-3xl font-bold lg:w-2/3 md:w-3/3'>Liderazgo ágil, impulsado por la inteligencia artificial.</h1>
        ...
        <button className='p-2 duration-300 hover:bg-secondary bg-primary rounded-3xl lg:text-lg md:text-lg sm:text-normal text-tertiary'>Comienza ya!</button>
      </div>
