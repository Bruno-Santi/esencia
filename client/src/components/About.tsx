...
export const About = () => {
  return (
    <section className=' lg:mt-40 md:mt-40 sm:mt-12 lg:h-screen md:h-screen sm:h-screen bg-white min-w-full   flex relative'>
      <div className='lg:flex-row md:flex-row sm:flex sm:flex-col-reverse sm:mt-12 sm:p-2 items-center lg:justify-between md:justify-between sm:justify-center'>
        ...
        <div className='font-inter text-primary md:mr-40 lg:mr-40 lg:w-2/6 md:w-3/6 sm:w-5/6'>
