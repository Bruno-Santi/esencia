  ...
  return (
    <div className='w-full lg:min-h-screen md:min-h-screen bg-primary bg-contain sm:min-h-screen'>
      <img
        ...
        alt='esencia.app logo'
      />
      <div className='flex flex-col sm:pt-10'>
        <h4 className='text-tertiary font-normal tracking-tighter flex mt-20 md:text-3xl lg:text-5xl sm:text-2xl font-poppins mx-auto'>Bienvenido!</h4>
