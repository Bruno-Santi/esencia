export const BoardReport = ({ title, value }) => {
  ...
  return (
    <div className='lg:w-[110px] md:w-[90px]   flex flex-col items-center bg-quaternary lg:mt-10 md:px-4  lg:h-20 md:h-20 sm:w-20 dark:bg-quaternary/40 shadow-md shadow-primary/20  '>
      <div>
