...
export const NoTeams = () => {
  ...
  return (
    <div className='flex flex-col justify-center mx-auto text-3xl w-2/4 font-light text-center pt-48 text-primary/70 font-poppins dark:text-tertiary'>
      ...
      <div className='mx-auto mb-8 dark:text-tertiary'>
        It seems that you haven't created a team yet! What if you take that step now and set the foundation for collaborative success?
      </div>
      <div className='mx-auto'>
